  ...
  <div class="container grid px-6 mx-auto">
    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto">
        ...
        <div class="text-gray-800 text- font-semibold px-4 py-2 mb-2 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:text-gray-400 ">
          <h2 class="">Subject : {{ $item->judul }}</h2>
        </div>
