      ...
      >
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2 flex items-center justify-center ">
            <img
              aria-hidden="true"
              class=" sm:w-full md:w-1/2  h-auto dark:hidden"
              src="{{asset('images/pose08_male.png')}}"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class=" hidden sm:w-full md:w-1/2  h-auto dark:block"
              src="{{asset('images/pose08_male.png')}}"
              alt="Ofdsdfice"
            />
          </div>
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              for="nim">
                ...
                <input
                  id="nim" type="text"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input form-control @error('nim') is-invalid @enderror"
